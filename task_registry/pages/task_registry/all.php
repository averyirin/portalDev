...
$title = elgg_echo('tasks');
$siteUrl = elgg_get_site_url();
$pluginUrl = $siteUrl."mod/task_registry";
...
<script src='$wettoolkit_url/js/controllers/TaskController.js'></script>
<script src='$wettoolkit_url/js/controllers/TaskDashboardController.js'></script>
...
<script src='$wettoolkit_url/js/services/TaskService.js'></script>
...
<section ng-app='portal' ng-controller='MainCtrl' style='position:relative;'>
	<link rel='stylesheet' href='mod/task_registry/css/styles.css'/>
...
$sidebar = elgg_view('task_registry/sidebar/filter');
$sidebar .= elgg_view('task_registry/sidebar/find');
...
$body = elgg_view_layout('one_column', array(
	...
	'title' => null,
	'sidebar' => null,
	'filter_override' => elgg_view('task_registry/nav', array('selected' => $vars['page'])),
));
